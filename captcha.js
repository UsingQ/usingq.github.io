...
var randomVis = new Array(20).fill(0);
...
function refreshCaptcha(){
    ...
    t2 = Math.floor(Math.random() * 9);
    (captchaAns[t2] != 1) ? ansNum++ : ansNum = ansNum;
    captchaAns[t2] = 1;
    for(var i = 0; i < 9; ++i){
        document.getElementById("c" + (i + 1)).setAttribute('style', 'background: url(images/' + captchaAns[i] + randomPic[i] + '.jpg); background-size:90px 90px;');
